...
public class select extends BasePopListActivity<MoneyMakingHallBean> {
    ...
    protected void initLayoutManager() {
        ...
        mRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent it = new Intent(select.this,DetailsActivity.class);
        ...
        m_cbOrderBy.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                filterTabToggle(isChecked, m_cbOrderBy,new MoneyTypeCheckedAdapter(select.this,m_isType ? m_arrOrderByBean : m_arrOrderByBeans),new AdapterView.OnItemClickListener() {
                    @Override
        ...
        m_cbAmount.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                filterTabToggle(isChecked, m_cbAmount,new MoneyTypeCheckedAdapter(select.this,m_arrOrderByAmountBeans),new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                        m_strOrderBy = "";
        ...
        m_tvBusiness.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it = new Intent(select.this,BusinessActivity.class);
                startActivity(it);
            }
        });
        ...
        m_teRelease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (m_strCategoryNo){
                    case Const.CategoryNo.TYPE_RENOVATION:
                        it = new Intent(select.this,ReleaseRenovationActivity.class);
                        nResultCode = RELEASE_RENOVATION;
                        break;
                    case Const.CategoryNo.TYPE_BUILDING:
                        it = new Intent(select.this,ReleaseBuildingActivity.class);
                        break;
                    case Const.CategoryNo.TYPE_REDUCE_WEIGHT:
                        it = new Intent(select.this,ReleaseReduceWeightActivity.class);
                        break;
                    case Const.CategoryNo.TYPE_QUIT_SMOKING:
                        it = new Intent(select.this,ReleaseSmokingActivity.class);
                        break;
                    case Const.CategoryNo.TYPE_QUIT_DRINKING:
                        it = new Intent(select.this,ReleaseDrinkingActivity.class);
                        break;
                    case Const.CategoryNo.TYPE_GIVE_UP_GAMBLING:
                        it = new Intent(select.this,ReleaseGiveUpGamblingActivity.class);
                        break;
                }
                it.putExtra("strCategoryNo",m_strCategoryNo);
    ...
    private void showPopAllType(boolean isChecked){
        filterTabToggle(isChecked, m_cbAllType,new MoneyTypeCheckedAdapter(select.this,m_arrAllType),new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                hidePopListView();
                ...
                if(strCategoryNo.equals(Const.CategoryNo.DESIGNER_ENTREPRENEURSHIP)){
                    it = new Intent(select.this,EntrepreneurshipActivity.class);
                    ...
                    Utils.showToast(select.this,"敬请期待~!");
                }
    ...
    protected void requestCheckBoxAllType(final boolean isChecked){
        HttpClient.get(ApiStores.categories, new HttpCallback<ResponseMoneyMakingHallTypeBean>() {
            ...
            public void OnFailure(String message) {
                ...
                AlertUtils.MessageAlertShow(select.this, "错误", message);
            }
