...
public class ReleaseGiveUpGamblingActivity extends BaseAppCompatActivity
{
...
//    }
    ...
    private void onCLickView()
    {
        ...
        m_tvJoinCount.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                PopUitls.showPopSelect(ReleaseGiveUpGamblingActivity.this, m_strArrNoSelect, "参与商家数量", new OnTaskSuccessComplete()
                {
                    @Override
                    public void onSuccess(Object obj)
                    {
        ...
        m_tvCity.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                AddressPickTask task = new AddressPickTask(ReleaseGiveUpGamblingActivity.this);
    ...
    private void openRadios()
    {
        RxGalleryFinal rxGalleryFinal = RxGalleryFinal
                .with(ReleaseGiveUpGamblingActivity.this)
                .image()
                .multiple();
