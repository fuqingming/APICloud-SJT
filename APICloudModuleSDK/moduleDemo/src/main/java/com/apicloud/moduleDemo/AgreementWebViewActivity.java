...
public class AgreementWebViewActivity extends BaseAppCompatActivity
{
    ...
    {
        m_viewWeb = findViewById(R.id.webview);
    ...
    {
        Utils.initCommonTitle(this,"协议",true);
...
//                "<body><h2>使用webview显示 html代码</h2></body></html>", "text/html" , "utf-8", null);
    ...
    private WebViewClient webViewClient=new WebViewClient()
    {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url)
        {
            ...
            {
                Toast.makeText(AgreementWebViewActivity.this,"国内不能访问google,拦截该url", Toast.LENGTH_LONG).show();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        if (m_viewWeb.canGoBack() && keyCode == KeyEvent.KEYCODE_BACK)
        {//点击返回按钮的时候判断有没有上一页
