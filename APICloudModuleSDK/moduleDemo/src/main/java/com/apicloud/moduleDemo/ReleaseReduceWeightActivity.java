...
public class ReleaseReduceWeightActivity extends BaseAppCompatActivity {
    ...
    protected int setLayoutResourceId() {
        return R.layout.activity_release_reduce_weight;
    }
...
//    }
    ...
    private void onCLickView() {
        ...
        m_tvStartData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopUitls.showDataSelect(ReleaseReduceWeightActivity.this, new OnTaskSuccessComplete() {
                    @Override
        ...
        m_tvJoinCount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopUitls.showPopSelect(ReleaseReduceWeightActivity.this, m_strArrNoSelect, "参与商家数量", new OnTaskSuccessComplete() {
                    @Override
                    public void onSuccess(Object obj) {
        ...
        m_tvCity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AddressPickTask task = new AddressPickTask(ReleaseReduceWeightActivity.this);
    ...
    private void openRadios() {
        RxGalleryFinal rxGalleryFinal = RxGalleryFinal
                .with(ReleaseReduceWeightActivity.this)
                .image()
                .multiple();
