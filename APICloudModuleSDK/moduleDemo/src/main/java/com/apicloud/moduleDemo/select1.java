...
public class select1 extends BaseAppCompatActivity {
...
//        }
    ...
    private void onClickView() {
        ...
        m_llPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                m_pwMenu = new TelephonePopupWindow(select1.this);
        ...
        m_llComment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(select1.this,CommentActivity.class);
        ...
        m_llReceive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(select1.this,CommitVoucherActivity.class);
                startActivity(it);
            }
        });
    ...
    private void initView(ResponseMoneyMakingDetailsBean response){
        ...
        ImageLoader.getInstace().loadCircleImg(select1.this, m_ivIcon, data.getUserInfo().getAvatar(),R.mipmap.head_s);
            ...
            public void onNext(ResponseBody responseBody) {
                ...
                try {
                    ...
                    if(beanjson.getSuccess()){
                        Utils.showToast(select1.this,"活动已经关闭");
                        initView(beanjson);
        ...
        ApiStores.joinActivity(m_strScheduleNo,m_strPersonnelAmount,new HttpCallback<ResponseMoneyMakingDetailsBean>() {
            ...
            public void OnSuccess(ResponseMoneyMakingDetailsBean response) {
                if(response.getSuccess()){
                    Utils.showCommonDialogVerifyCode(select1.this, kProgressHUD, AppSettings.getPhone(), "", new OnTaskSuccessComplete() {
                        @Override
                        public void onSuccess(Object obj) {
                            Intent it = new Intent(select1.this,PaymentActivity.class);
                            it.putExtra("strScheduleNo",m_strScheduleNo);
                            it.putExtra("strTitle",m_strTitle);
//                            it.putExtra("strTitleType",response.getData().getCategoryName()+"-"+response.getData().getTitle()+"活动保证金");
            ...
            public void OnFailure(String message) {
                AlertUtils.MessageAlertShow(select1.this, "错误", message);
            }
